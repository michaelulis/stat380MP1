...
>>>>>>> 535883b4a7b8d8fed25a3d3a4b85678f15c550c2
...
## Part 4a (I extracted month from the Date column and got it into abbreviated format)
```{r}
COD <- COD %>%
  mutate(month = month(as.POSIXlt(Date, format = "%m/%d/%Y")))
COD$month <- month.abb[COD$month]
```
